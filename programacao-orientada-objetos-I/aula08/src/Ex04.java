...
public class Ex04 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int n = 0; n < 4; n++) {
            nomes[n] = JOptionPane.showInputDialog("Digite o nome " + (n + 1) + ": ");
            soma = 0.0;
            for (int p = 0; p < 3; p++) {
                notas[n][p] = Double.parseDouble(JOptionPane.showInputDialog("Digite a nota " + (p + 1) + " de " + nomes[n] + ": "));
                soma = soma + notas[n][p];
            }
            media = soma / 3;
            ...
            textarea.append("Aluno: " + nomes[n] + ", Média: " + mediaFormatada + ", Status: " + status + "\n");
        }
